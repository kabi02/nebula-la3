export default function Newsletter() {
    return (
        <div className="flex bg-[#6B7280] w-full items-center justify-center py-10 gap-12">
           <div className="order-1 w-[30%] flex justify-end"><img src="./assets/email.png"></img></div> 
            <div className="flex flex-col justify-center gap-2 order-2 font-open-sans text-white w-[60%]">
                ...
                <form action="#" className="flex w-[70%]">
                    <input className="font-open-sans text-gray-900 font-light w-[65%] rounded-xl px-5 mr-5 bg-gray-100" type="text" name="email" id="email" placeholder="Enter your Email..." required />
